...
const Appointment = () => {
  ...
  useEffect(() => {
    emailjs.init("rNZMqWzKrnXVmrDs2"); // Your User ID
  }, []);
    ...
    try {
      ...
      if (response.data.status === "success") {
        ...
        if (newStatus === "confirmed") {
          ...
          const emailParams = {
            user_name: booking.userId?.UName || booking.userName,
            clinic_name: booking.clinicName,
            doctor_name: booking.doctorId?.DoctorName[0] || booking.doctorName,
            ...
            to_email: booking.userId?.Email, // Dynamic recipient email
          };

          await emailjs.send(
            "service_80dei54", // Your Service ID
            "template_e8lslbs", // Confirmation Template ID
            emailParams
          );
          console.log("Confirmation email sent successfully!");
          alert(`Booking confirmed successfully! A confirmation email has been sent to ${booking.userId?.Email || "N/A"}`);
        } else {
      ...
      setError("An error occurred while updating the booking status or sending the email");
    }
  };
                ...
                >
                  <thead>
                    ...
                    >
                      ...
                      <th style={{ padding: "15px", fontWeight: "600", textAlign: "left" }}>Email</th>
